...
function StepCard({ id, stepWidth, stepNo, stepClass, stepDesc, stepMap, stepStudent, stepDescImg }) {
  ...
  return (
    <div className={`step-card step-card-${id} ${styles[stepWidth]} relative`} key={id}>
      ...
      {
        (id===5) &&
        <div className={`flex relative top-[5%] left-[100%] step-last-card ${styles['last-card']}`}>
          <div className='w-[252px]'>
            <Image src={stepStudent} alt='step-stundet'/>
          </div>
