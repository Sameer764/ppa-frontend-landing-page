...
function CertificationCard({id,courseImg,courseAlt,courseHead,courseEnrolled,courseRating,courseType}) {
  return (
    <div key={id} className='lg:w-[421px] w-full lg:p-[12px] p-[0px] lg:border lg:border-[#E2E8F0] lg:bg-[#ffffff] rounded-[20px]'>
      <div>
      ...
      <div className='lg:mt-[20px] mt-[12px] flex gap-[20px]'>
